                                                ...
                                                <div class="clearfix">
                                                	<div class="switch onoffswitch-data pull-left">
                                                		<div class="onoffswitch">
                                                			<input type="checkbox" class="onoffswitch-checkbox" id="<?php echo $option['key'];?>" name="<?php echo $option['key'];?>"<?php echo 'Yes' == $tpl['option_arr'][$option['key']] ? ' checked="checked"' : NULL;?>>
