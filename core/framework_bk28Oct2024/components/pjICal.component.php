...
class pjICal
{
    ...
    public function process($data=array())
    {
        ...
        foreach ($data as $item)
        {
            ...
            $str .= "SUMMARY:" . pjSanitize::clean($item[$this->summary]).$this->eol;
            $str .= "DESCRIPTION: Name: ".pjSanitize::clean($item[$this->c_name]).$this->eol;
            $str .= "LOCATION:" . pjSanitize::clean($item[$this->location]).$this->eol;
