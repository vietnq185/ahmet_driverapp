...
class pjAdminScheduleNew extends pjAdmin
{
    ...
    public function pjActionIndex()
    {
        ...
        ->appendJs('pjAdminScheduleNew.js');
    }
    ...
    public function pjActionSyncAllData()
    {
        ...
        $this->appendJs('pjAdminScheduleNew.js');
    }
    ...
    public function pjActionSyncGeneralData()
    {
        ...
        pjUtil::redirect($_SERVER['PHP_SELF'] . "?controller=pjAdminScheduleNew&action=pjActionIndex&date=" . $date);
    }
