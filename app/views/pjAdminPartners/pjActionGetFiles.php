<div class="gallery-container">
    <?php if ($tpl['arr']) { ?>
        <?php foreach ($tpl['arr'] as $val) { 
            ...
            $is_image = in_array($extension, array('jpg', 'jpeg', 'png', 'gif'));
            $download_url = $_SERVER['PHP_SELF'] . "?controller=pjAdminPartners&amp;action=pjActionDownloadFile&amp;id=" . $val['id'];
        	...
        	<?php if ($is_image) { ?>
                <div class="photo-column">
                    ...
                    <div class="delete-action">
                        ...
                        <a href="javascript:void(0);" class="text-danger btn-delete-file" data-id="<?php echo $val['id'];?>" data-foreign_id="<?php echo $foreign_id;?>" title="<?php __('btnDelete');?>"><i class="fa fa-trash-o"></i></a>
                    </div>
                </div>
        	<?php } else { ?>
                <div class="file-column">
                        ...
                        <div class="delete-action">
                        	<a href="<?php echo $download_url; ?>" class="btn-action btn-download" title="Download"><i class="fa fa-download"></i></a>&nbsp;&nbsp;
                            <a href="javascript:void(0);" class="text-danger btn-delete-file" data-foreign_id="<?php echo $foreign_id;?>" data-id="<?php echo $val['id'];?>" title="<?php __('btnDelete');?>"><i class="fa fa-trash-o"></i></a>
                        </div>
                    </div>
            	<?php } ?>
        <?php } ?>
