<div class="form-group">
	...
	<textarea name="message" id="message" class="form-control required" rows="5" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>"><?php echo stripslashes(str_replace(array('\r\n', '\n'), '&#10;', $tpl['message'])); ?></textarea>
</div>