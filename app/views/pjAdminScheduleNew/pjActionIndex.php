		...
		<div class="col-lg-12">
			...
			<div class="ibox float-e-margins">
				<div class="ibox-content">
					<?php
					if ($controller->isDriver()) {
						include PJ_VIEWS_PATH.'pjAdminScheduleNew/elements/driver.php';
					} else {
						include PJ_VIEWS_PATH.'pjAdminScheduleNew/elements/general.php';
					}
					?>
				</div>
			</div>
        	...
        	<div class="form-group">
                <div class="input-group input-group-captcha">
                    ...
                    <span class="input-group-addon">
                        <img id="captchaImage" src="<?php echo PJ_INSTALL_URL; ?>index.php?controller=pjAdminScheduleNew&amp;action=pjActionCaptcha&amp;rand=<?php echo rand(1, 99999); ?>" alt="Captcha" class="captcha captchaImage" title="<?php __('plugin_base_captcha_reload', false, true); ?>">
                    </span>
                </div>
