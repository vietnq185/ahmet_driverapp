...
<div class="row">
	<div class="<?php echo $controller->isDriver() ? 'col-md-6 col-md-offset-3' : 'col-md-10 col-md-offset-1'?> pjSbViewOrderDetails">
		...
		<?php } ?>
		<?php if (isset($tpl['second_driver_arr']) && $tpl['second_driver_arr']) { ?>
			<div class="alert alert-danger"><?php __('lblSecondVehiclesDriver');?>: <?php echo pjSanitize::html($tpl['second_driver_arr']['name']);?>, <?php echo pjSanitize::html($tpl['second_driver_arr']['phone']);?></div>
		<?php } ?>
		<?php 
