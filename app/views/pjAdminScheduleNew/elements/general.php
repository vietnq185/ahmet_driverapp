	...
	<div class="row">
		...
		<div class="col-sm-6 col-xs-12 text-right hidden-md hidden-sm hidden-xs">
			<div class="form-group">
				...
				?> 
				<a class="btn btn-primary btnSyncAllData" data-href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminScheduleNew&action=pjActionSyncAllData" href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminScheduleNew&amp;action=pjActionSyncAllData&amp;date=<?php echo date($tpl['option_arr']['o_date_format']); ?>"><?php __('btnSynchronizeData');?></a>
				<a class="btn btn-primary btnSycGeneralData" data-href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminScheduleNew&action=pjActionSyncGeneralData" href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminScheduleNew&amp;action=pjActionSyncGeneralData&amp;date=<?php echo date($tpl['option_arr']['o_date_format']); ?>"><?php __('btnUpdateBookings');?></a>
			</div>
		</div>
		<div class="col-xs-12 text-center visible-md visible-sm visible-xs">
			...
			<div class="form-group">
				<a class="btn btn-primary 2" href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminScheduleNew&amp;action=pjActionSyncAllData"><?php __('btnSynchronizeData');?></a>
				<a class="btn btn-primary" href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminScheduleNew&amp;action=pjActionSyncGeneralData"><?php __('btnUpdateBookings');?></a>
			</div>
		</div>
	</div>
	<div class="row">
