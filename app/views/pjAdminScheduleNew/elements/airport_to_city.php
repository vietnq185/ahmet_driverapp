...
<div class="pjSbBlock">
	...
	<div class="pjSbBlockInner">
		...
		<div class="pull-left pjSbOrderInfo">
			<h3><?php __('lblFlightArrivalTime');?></h3>
			...
			<?php if (!empty($tpl['arr']['c_flight_number'])) { ?>
				<p><?php __('lblArrivalFlightNumber');?>: <?php echo pjSanitize::html($tpl['arr']['c_flight_number']);?></p>
			<?php } ?>
			<?php if (!empty($tpl['arr']['c_airline_company'])) { ?>
...
<div class="pjSbBlock">
	<div class="pjSbBlockInner">
		...
		<div class="pull-left pjSbOrderInfo">
			...
			<?php 
			$c_destination_address = (int)$tpl['arr']['return_id'] > 0 ? pjSanitize::html($tpl['arr']['c_address2']) : pjSanitize::html($tpl['arr']['c_destination_address']);
			$c_hotel = (int)$tpl['arr']['return_id'] > 0 ? pjSanitize::html($tpl['arr']['c_hotel2']) : pjSanitize::html($tpl['arr']['c_hotel']);
			?>
			<?php if (!empty($c_destination_address)) { ?>
				<p><?php echo pjSanitize::html($c_destination_address);?></p>
			<?php } ?>
			<?php if (!empty($c_hotel)) { ?>
				<p><?php echo pjSanitize::html($c_hotel);?></p>
			<?php } ?>
			<?php if (!empty($tpl['arr']['google_map_link'])) { ?>
				<p><a class="btn btn-primary btn-block" href="<?php echo pjSanitize::html($tpl['arr']['google_map_link']);?>" target="_blank"><?php __('btnOpenGoogleMaps');?></a></p>
			<?php } ?>
		</div>
		<br class="pjSbClearBoth"/>
	</div>
