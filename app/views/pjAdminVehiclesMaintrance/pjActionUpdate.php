...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-sm-12">
        <div class="row">
            <div class="col-sm-12">
                <h2><?php __('infoUpdateVehiclesMaintranceTitle');?></h2>
                <ol class="breadcrumb">
					...
					<li class="active">
						<strong><?php __('infoUpdateVehiclesMaintranceTitle');?></strong>
					</li>
				</ol>
            </div>
        </div>

        <p class="m-b-none"><i class="fa fa-info-circle"></i> <?php __('infoUpdateVehiclesMaintranceBody'); ?></p>
    </div>
</div>
...
<div class="row wrapper wrapper-content animated fadeInRight">
    <div class="col-lg-12">
        <div class="ibox float-e-margins">
			<form action="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminVehiclesMaintrance&amp;action=pjActionUpdate" method="post" id="frmUpdate" class="form pj-form" autocomplete="off" enctype="multipart/form-data">
				<input type="hidden" name="action_update" value="1" />
				<input type="hidden" name="id" value="<?php echo pjSanitize::html($tpl['arr']['id']);?>" />
				<input type="hidden" name="foreign_id" id="foreign_id" value="<?php echo pjSanitize::html($tpl['arr']['id']);?>" />
            	...
            	<div class="ibox-content">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select name="vehicle_id" class="form-control select-item required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                                	...
                                	<?php foreach ($tpl['vehicle_arr'] as $vel) { ?>
                                		<option value="<?php echo $vel['id'];?>" <?php echo $tpl['arr']['vehicle_id'] == $vel['id'] ? 'selected="selected"' : '';?>><?php echo pjSanitize::html($vel['name']);?> | <?php echo pjSanitize::html($vel['registration_number']);?></option>
                                	<?php } ?>
                                </select>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="make" value="<?php echo pjSanitize::html($tpl['arr']['make']);?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                            </div>
                            <div class="form-group">
                                <label><?php __('lblMaintranceVehicleVIN');?></label>
                                <input type="text" name="vin" value="<?php echo pjSanitize::html($tpl['arr']['vin']);?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                            </div>
                            <div class="form-group">
                                <label><?php __('lblMaintranceBuyedInKm');?></label>
                                <input type="text" name="buyed_in_km" value="<?php echo pjSanitize::html($tpl['arr']['buyed_in_km']);?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><?php __('lblMaintranceModel');?></label>
                                <input type="text" name="model" value="<?php echo pjSanitize::html($tpl['arr']['model']);?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                            </div>
                            <div class="form-group">
                                <label><?php __('lblMaintranceNetPrice');?></label>
                                <div class="input-group">
                    				<input type="text" name="net_price" id="net_price" value="<?php echo pjSanitize::html($tpl['arr']['net_price']);?>" class="form-control number text-right required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>" />
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tuv" value="<?php echo pjSanitize::html($tpl['arr']['tuv']);?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label><?php __('lblMaintranceMadeYear');?></label>
                                <input type="text" name="model_year" value="<?php echo pjSanitize::html($tpl['arr']['model_year']);?>" class="form-control required" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                            </div>
                            <div class="form-group">
                                <label><?php __('lblMaintranceBuyDate');?></label>
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="fa fa-calendar"></i></span> 
                                    <input type="text" name="buy_date" id="buy_date" value="<?php echo !empty($tpl['arr']['buy_date']) ? date($tpl['option_arr']['o_date_format'], strtotime($tpl['arr']['buy_date'])) : '';?>" class="form-control datepick required" readonly data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
                                </div>
                            </div>
                        </div>
                    </div>
        			...
        			<div class="grey-box">
                        <div class="row row-flex-center">
                            ...
                            <div class="col-md-3 text-right">
                                <button class="btn btn-default btn-upload btn-block btn-outline btn-primary btn-sm"" type="button" data-foreign_id="<?php echo pjSanitize::html($tpl['arr']['id']);?>" data-type="vehicle_photos"><?php __('btnAddVehiclePhotos');?></button>
                            </div>
                        </div>
        			</div>
        			<div class="grey-box">
                        <div class="row row-flex-center">
                            ...
                            <div class="col-md-3 text-right">
                                <button class="btn btn-default btn-upload btn-block btn-outline btn-primary btn-sm"" type="button" data-foreign_id="<?php echo pjSanitize::html($tpl['arr']['id']);?>" data-type="vehicle_documents"><?php __('btnAddVehicleDocuments');?></button>
                            </div>
                        </div>
        			</div>
                    <hr>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group"><label><?php __('lblInternet');?></label><input type="text" name="internet" value="<?php echo pjSanitize::html($tpl['arr']['internet']);?>" class="form-control"></div>
                            <div class="form-group"><label><?php __('lblGPS');?></label><input type="text" name="gps" value="<?php echo pjSanitize::html($tpl['arr']['gps']);?>" class="form-control"></div>
                            <div class="form-group"><label><?php __('lblTelepass');?></label><input type="text" name="telepass" value="<?php echo pjSanitize::html($tpl['arr']['telepass']);?>" class="form-control"></div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group"><label><?php __('lblTollBrenner');?></label><input type="text" name="toll_brenner" value="<?php echo pjSanitize::html($tpl['arr']['toll_brenner']);?>" class="form-control"></div>
                            <div class="form-group"><label><?php __('lblTollArlberg');?></label><input type="text" name="toll_arlberg" value="<?php echo pjSanitize::html($tpl['arr']['toll_arlberg']);?>" class="form-control"></div>
                            <div class="form-group"><label><?php __('lblSwissVignette');?></label><input type="text" name="swiss_vignette" value="<?php echo pjSanitize::html($tpl['arr']['swiss_vignette']);?>" class="form-control"></div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group"><label><?php __('lblAustriaVignette');?></label><input type="text" name="austria_vignette" value="<?php echo pjSanitize::html($tpl['arr']['austria_vignette']);?>" class="form-control"></div>
                        </div>
                    </div>
        
                    <div class="form-group">
                        <label><?php __('lblNotes');?></label>
                        <textarea class="form-control" rows="4" name="notes"><?php echo pjSanitize::html($tpl['arr']['notes']);?></textarea>
                    </div>
                    
                    <div id="dynamic-fields-container" style="margin-top: 15px;">
                    	<?php if ($tpl['vm_attr_arr']) { ?>
                    		<?php foreach ($tpl['vm_attr_arr'] as $vma) { ?>
                    			<div class="row row-flex-center custom-field-row" style="margin-bottom: 10px; display: flex; align-items: center;">
                                    <div class="col-md-4">
                                        <select name="attr_cat[<?php echo $vma['id'];?>]" class="form-control field-type-select">
                                            <option value="">-- <?php __('lblChoose');?> --</option>
                                            <?php foreach ($tpl['attribute_arr'] as $val) { ?>
                                            	<option value="<?php echo $val['id'];?>" <?php echo $vma['attribute_type_id'] == $val['id'] ? 'selected="selected"' : '';?>><?php echo pjSanitize::html($val['name']);?></option>
                                            <?php } ?>
                                            <option value="other"><?php __('lblOtherNewAttribute');?></option>
                                        </select>
                                        <input name="new_attr_cat[<?php echo $vma['id'];?>]" type="text" class="form-control custom-label-input" style="display:none; margin-top:5px;">
                                    </div>
                                    <div class="col-md-7">
                                        <input name="attr_content[<?php echo $vma['id'];?>]" value="<?php echo pjSanitize::html($vma['content']);?>" type="text" class="form-control">
                                    </div>
                                    <div class="col-md-1 text-center">
                                        <button type="button" class="btn btn-link text-danger btn-delete-attribute" data-id="<?php echo $vma['id'];?>" title="<?php __('btnDelete');?>">
