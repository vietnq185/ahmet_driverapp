...
if (isset($tpl['arr']) && !empty($tpl['arr']))
{
	...
	<form action="" method="post" class="form pj-form">
		...
		<input type="hidden" name="vehicle_id" value="<?php echo $tpl['arr']['id'];?>" />
		<div class="modal-header">
			...
			<h3 class="modal-title" id="myModalLabel"><?php __('infoAddServiceRepair'); ?></h3>
		</div>
			...
			<div class="row m-t-sm">
				<div class="col-sm-12">
        			...
        			<div class="form-group">
        				...
        				<input type="text" class="form-control required" name="km" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">
        			</div>
        			...
        			<div class="form-group">
        				...
        				foreach ($tpl['lp_arr'] as $v)
        				{
        					...
        					<div class="<?php echo $tpl['is_flag_ready'] ? 'input-group' : '';?> pj-multilang-wrap" data-index="<?php echo $v['id']; ?>" style="display: <?php echo (int) $v['is_default'] === 1 ? NULL : 'none'; ?>">
        						<input type="text" class="form-control<?php echo (int) $v['is_default'] === 0 ? NULL : ' required'; ?>" name="i18n[<?php echo $v['id']; ?>][service]" data-msg-required="<?php __('plugin_base_this_field_is_required', false, true);?>">	
        						<?php if ($tpl['is_flag_ready']) : ?>
		...
		<div class="modal-footer">
			<button type="button" class="btn btn-primary btnConfirmAddServiceRepair"><?php __('btnSave'); ?></button>
