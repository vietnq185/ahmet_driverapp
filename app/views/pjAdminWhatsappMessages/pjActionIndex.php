...
?>
		...
		<div class="col-sm-12">
			<div class="row">
				<div class="col-lg-9 col-md-8 col-sm-6">
					<h2><?php __('infoWhatsappMessagesTitle'); ?></h2>
				</div>
			...
			<p class="m-b-none"><i class="fa fa-info-circle"></i><?php __('infoWhatsappMessagesBody'); ?></p>
		</div>
	</div>
	...
	<div class="row wrapper wrapper-content animated fadeInRight">
		...
		<div class="col-lg-4">
			<div class="panel no-borders boxFormWM">
				<?php 
				if(pjAuth::factory('pjAdminWhatsappMessages', 'pjActionCreate')->hasAccess())
				{
	...
	var pjGrid = pjGrid || {};
	pjGrid.queryString = "";
	myLabel.selected_wm_id = 0;
	<?php if (isset($get['id']) && (int)$get['id'] > 0)
	{
		?>
		myLabel.selected_wm_id = <?php echo (int)$get['id'];?>;
		<?php 
	}
	?>
	pjGrid.hasAccessCreate = <?php echo pjAuth::factory('pjAdminWhatsappMessages', 'pjActionCreate')->hasAccess() ? 'true' : 'false';?>;
	pjGrid.hasAccessUpdate = <?php echo pjAuth::factory('pjAdminWhatsappMessages', 'pjActionUpdate')->hasAccess() ? 'true' : 'false';?>;
	pjGrid.hasAccessDeleteSingle = <?php echo pjAuth::factory('pjAdminWhatsappMessages', 'pjActionDelete')->hasAccess() ? 'true' : 'false';?>;
	...
	myLabel.inactive = "<?php __('wm_statuses_ARRAY_F'); ?>";
