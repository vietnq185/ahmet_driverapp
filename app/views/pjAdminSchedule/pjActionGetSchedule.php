			...
			<thead>
				<tr>
					<?php foreach ($tpl['vehicle_arr'] as $veh) { 
					    $vehicle_from_api = isset($tpl['vehicle_from_api_arr'][$veh['registration_number']]) ? $tpl['vehicle_from_api_arr'][$veh['registration_number']] : array();
					    ?>
						<th>
				...
				<tr>
					<?php foreach ($tpl['vehicle_arr'] as $i => $veh) { ?>
						<td class="<?php echo $i%2 == 0 ? 'odd' : 'even';?> <?php echo $veh['schedule_status'] == 'T' ? ' pjSbOrdersVehicleActive' : ' pjSbOrdersVehicleInactive';?>" align="center">
							...
							<h4 class="text-warning pjVehicleDrivenKm pjVehicleDrivenKm_<?php echo $veh['id'];?>_1" style="margin-bottom: 0;"><?php echo isset($tpl['vehicle_driven_km_arr'][$veh['id']][1]) ? $tpl['vehicle_driven_km_arr'][$veh['id']][1]['info'] : '';?></h4>
						</td>
					<?php } ?>
				</tr>
				<tr>
				...
				<tr>
					<?php foreach ($tpl['vehicle_arr'] as $i => $veh) { ?>
						<td class="<?php echo $i%2 == 0 ? 'odd' : 'even';?>  <?php echo $veh['schedule_status'] == 'T' ? ' pjSbOrdersVehicleActive' : ' pjSbOrdersVehicleInactive';?>" align="center">
							...
							<h4 class="text-warning pjVehicleDrivenKm pjVehicleDrivenKm_<?php echo $veh['id'];?>_2" style="margin-bottom: 0;"><?php echo isset($tpl['vehicle_driven_km_arr'][$veh['id']][2]) ? $tpl['vehicle_driven_km_arr'][$veh['id']][2]['info'] : '';?></h4>
						</td>
					<?php } ?>
				</tr>
				<tr>
