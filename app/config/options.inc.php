...
if (!defined("PJ_SCRIPT_ID")) define("PJ_SCRIPT_ID", "146");
if (!defined("PJ_SCRIPT_BUILD")) define("PJ_SCRIPT_BUILD", "3.0.2");
if (!defined("PJ_SCRIPT_PREFIX")) define("PJ_SCRIPT_PREFIX", "transfer_");
...
$CONFIG = array();
$CONFIG['plugins'] = array('pjBase', 'pjAuth', 'pjInstaller');
...
$CONFIG['role_permissions_driver'] = array(
		'pjBaseUsers_pjActionProfile',
		// Script permissions
		'pjAdminSchedule',
		'pjAdminSchedule_pjActionIndex',
        'pjAdminSchedule_pjActionSyncGeneralData'
);
