...
class pjFleetDiscountModel extends pjAppModel
{
	protected $primaryKey = 'id';
	
	protected $table = 'fleets_discounts';
	...
	protected $schema = array(
		...
		array('name' => 'is_subtract', 'type' => 'enum', 'default' => 'T')
	);
	
	public static function factory($attr=array())
	{
		return new pjFleetDiscountModel($attr);
	}
}
?>